...
const HOST = process.env.HOST || '99.999.99.999'; // Tu IP pública
...
// ============================================
// ⚙️ MIDDLEWARE ACTUALIZADO PARA PRODUCCIÓN
// ============================================
...
if (hasFrontend) {
  ...
  console.log('🚀 Modo: Backend + Frontend Integrado - Producción');
} else {
  console.log('🔧 Modo: Solo API (Frontend por separado)');
}
...
app.use(session({
  secret: process.env.SESSION_SECRET || 'sage200-secret-key-2024-produccion',
  resave: false,
...
// ============================================
// 🛣️ RUTA PARA SERVIR FRONTEND (SPA)
// ============================================
...
app.listen(PORT, HOST, () => {
  console.log(`\n🚀 Servidor Sage200 Contabilidad iniciado:`);
  console.log(`📍 URL: http://${HOST}:${PORT}`);
  console.log(`📊 Puerto: ${PORT}`);
  console.log(`🌐 Modo: ${hasFrontend ? 'Integrado (Frontend + Backend)' : 'Solo API'}`);
